...
public:
	ParticleGenerator() {}
	// Constructor
	ParticleGenerator(snowShader newShader, snowMesh newMesh, GLuint totamount, GLuint initamount, glm::vec3 position, float growPerUpdate, glm::vec3 newPosrange,
	...
	ParticleGenerator(snowShader newShader, snowMesh newMesh, GLuint totamount, GLuint initamount, glm::vec3 position, float growPerUpdate, glm::vec3 newGenWidth, glm::vec3 newGenDepth,
		glm::vec4 newStartColor, glm::vec4 newStartcolorrange,
		glm::vec4 newEndColor, float newShininess,
		float newAvglife, float newLiferange,
		float newAngle, float newAnglerange, float newRotaterange, glm::vec3 newAxis,
